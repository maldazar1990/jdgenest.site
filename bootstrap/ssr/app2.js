...
function cleanByTag(e) {
  ...
  document.querySelectorAll(".clean-tag").forEach(function(e2) {
    e2.classList.remove("d-none");
  });
  document.querySelectorAll("a[data-listclass]:not([data-listclass*='" + classOrder + "'])").forEach(function(e2) {
    e2.classList.add("bg-primary");
    e2.classList.remove("bg-secondary");
  });
  document.querySelectorAll("li[data-listclass*='" + classOrder + "']").forEach(function(e2) {
    e2.classList.remove("d-none");
  });
  document.querySelectorAll("li[data-listclass]:not([data-listclass*='" + classOrder + "'])").forEach(function(e2) {
    e2.classList.add("d-none");
  });
  document.querySelectorAll("div[data-listclass*='" + classOrder + "']").forEach(function(e2) {
    e2.classList.remove("d-none");
  });
  document.querySelectorAll("div[data-listclass]:not([data-listclass*='" + classOrder + "'])").forEach(function(e2) {
    e2.classList.add("d-none");
  });
}
