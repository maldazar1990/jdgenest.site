...
return [
    ...
    'whitelist' => ["69.157.130.228",env('FIREWALL_WHITELIST', '127.0.0.1'), env('FIREWALL_WHITELIST', '::1'), env('FIREWALL_WHITELIST', 'localhost'), env('FIREWALL_WHITELIST', '192.168.2.*'),'192.168.2.216'],
    ...
    'middleware' => [
        ...
        'php' => [
            ...
            'auto_block' => [
                'attempts' => 1,
                'frequency' => 5 * 60, // 5 minutes
                'period' => 60 * 60 * 24 * 365, // 30 minutes
            ],
        ],
